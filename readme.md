...
|------|------------------|
| **Frontend** | React · Next.js · Tailwind CSS · Flutter · Dart |
| **Backend**  | JavaScript · TypeScript · Node.js · Express · PostgreSQL · MongoDB · GraphQL |
| **DevOps & Tooling** | Linux · Bash · Nix · Git · Docker · GitHub Actions · Kubernetes · Terraform · Ansible · Jenkins · AWS |
